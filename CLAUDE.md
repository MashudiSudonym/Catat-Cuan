...
This project is indexed by GitNexus as **Catat-Cuan** (5016 symbols, 11332 relationships, 175 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Catat-Cuan/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Catat-Cuan/clusters` | All functional areas |
| `gitnexus://repo/Catat-Cuan/processes` | All execution flows |
| `gitnexus://repo/Catat-Cuan/process/{name}` | Step-by-step execution trace |
